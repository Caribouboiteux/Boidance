...
[CustomEditor(typeof(FloatVRInteraction))]

public class FloatVRInteractionEditor : Editor
{

    public override void OnInspectorGUI()
    {
        FloatVRInteraction vi = (FloatVRInteraction)target;
        base.OnInspectorGUI();
        ...
        vi.featureValue = (InputFeatureUsage<float>)typeof(CommonUsages).GetField(name).GetValue(typeof(CommonUsages).GetField(name));
